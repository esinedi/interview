...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"interview","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var S = "development" === "development",
  ...
  T = I({
    ...
    "skipFiles": [
        "<node_internals>/**",
        "D:/Web/HBuilderX/plugins/unicloud/**/*.js"
    ]
}
),
  C = I([{"provider":"aliyun","spaceName":"interview-dev","spaceId":"mp-1df7f1bd-c2d6-43f6-9db4-13eb038c1fc1","clientSecret":"VMPlQ969nztTdFooY/7wRA==","endpoint":"https://api.next.bspapp.com"}]) || [],
  x = true;
var O = "";
try {
...
var _default = {
  ...
  "tabBar": {
    ...
    "list": [{
      ...
      "selectedIconPath": "static/img/tabBar/index-run.png"
    }, {
      "pagePath": "pages/mine/index",
      "text": "我的",
      "iconPath": "static/img/tabBar/mine.png",
      "selectedIconPath": "static/img/tabBar/mine-run.png"
    }]
  },
  "globalStyle": {
    "navigationBarTitleText": "面试葱",
...
/* WEBPACK VAR INJECTION */(function(uni, uniCloud) {var token = uni.getStorageSync('token');
...
exports.default = void 0;
var _marked = _interopRequireDefault(__webpack_require__(/*! ./marked.min */ 165));
/**
...
exports.default = void 0;
var _prism = _interopRequireDefault(__webpack_require__(/*! ./prism.min */ 167));
var _config = _interopRequireDefault(__webpack_require__(/*! ./config */ 168));
...
exports.default = void 0;
var _parser = _interopRequireDefault(__webpack_require__(/*! ./parser */ 170));
/**
